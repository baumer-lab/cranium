...
```{r Figure3, echo=FALSE, fig.cap="2D plot of a wild-type sample", out.width='90%', fig.show='asis'}
...
```{r Figure4, echo=FALSE, fig.cap="Model fit on a wild-type sample", out.width='90%', fig.show='asis'}
...
```{r Figure12, echo =FALSE, fig.cap="", out.width='80%', fig.show='asis'}
...
```{r Figure14, echo =FALSE, fig.cap="PCA ", out.width='80%', fig.show='asis'}
