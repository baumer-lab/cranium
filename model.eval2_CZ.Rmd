...
threshold_wt_all$threshold<- as.character(threshold_wt_all$threshold)


ggplot(data = threshold_wt_all, aes(x = threshold, y = adj.r.squared)) + geom_boxplot()  + labs(title = "Optimal threshold for wildtype")
```
