...
ggplot(data = threshold_yt, aes(x = threshold, y = adj.r.squared)) + geom_line()  + aes(colour = Sample) + theme(legend.position = "right") + labs(title = "Threshold trend sample -- Mutant")
