...
# correction B: rotate all data points with a rotation angle about x-axis
```{r}
#xy plane
...
c.data <- correct_errorB.tbl_brain(ro_tidy_brain_yt_1, threshold.n = 0.6)
plot2d(c.data, title = "rotate around x--1")


c2.data <- correct_errorB.tbl_brain(ro_tidy_brain_yt_1, threshold.n = 0.6)
...
c3.data <- correct_errorB.tbl_brain(ro_tidy_brain_yt_1, threshold.n = 0.6)
...
path = "Sample/WildType"
file_names <- list.files(path, pattern=".h5", full.names=TRUE)
brain_wt_06 <-read_h5(file_names[6])

tidy_brain_wt_06<- tidy(brain_wt_04, threshold.n = 0.6)
ro_tidy_brain_wt_06 <- reorient(tidy_brain_wt_06)
plot2d(ro_tidy_brain_wt_06, title = "error A correction example_original")

c.data <- correct_errorA.tbl_brain(ro_tidy_brain_wt_06, threshold.n =  0.6)
plot2d(c.data, title = "error A correction")
