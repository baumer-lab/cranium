...
threshold.list <- list(0.69, 0.72, 0.75, 0.78, 0.81, 0.84)
...
fitted_value_df_wt_final <- fitted_value_df_wt %>% 
  mutate(Sample=rep(c(1:43), 6)) %>% 
  mutate(threshold=c(rep(0.69, 43), rep(0.72, 43), rep(0.75, 43),rep(0.78, 43),
                     rep(0.81, 43), rep(0.84, 43)))


threshold_wt_all<- read_csv("visualization_results/threshold_wt_all.csv")%>%
  select(-X1)

threshold_wt_all2 <- rbind(threshold_wt_all, fitted_value_df_wt_final)



#write.csv(threshold_wt_all2, file = "visualization_results/threshold_wt_all2.csv",row.names=F)
```
